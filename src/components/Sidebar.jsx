        ...
        <nav className="flex-grow mt-4 space-y-2">
          ...
          >
            <svg
              ...
              stroke="currentColor"
            >
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 11V3a1 1 0 00-1-1H9a1 1 0 00-1 1v8M5 11h14l-1 9H6l-1-9z" />
            </svg>
            {isOpen && <span className="text-lg">Compras2</span>}
          </Link>
        </nav>
